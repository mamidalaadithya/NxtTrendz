# 🛍️ Nxt Trendz - Cart Features (React JS)

This project is part of the **Nxt Trendz** React series, focusing on **Cart Functionality** — including adding/removing products, quantity management, cart summary, and more — using **React Context API** and **Authentication**.

---

## 📹 Project Output Video

🎬 [Click here to watch the output](https://assets.ccbp.in/frontend/content/react-js/nxt-trendz-cart-features-output.mp4)

---

## 📐 Design Files

- 📱 [Small Screens](https://assets.ccbp.in/frontend/content/react-js/nxt-trendz-cart-features-sm-output-v0.png)
- 💻 [Large Screens](https://assets.ccbp.in/frontend/content/react-js/nxt-trendz-cart-features-lg-output.png)
- 🧺 [Empty Cart View](https://assets.ccbp.in/frontend/content/react-js/nxt-trendz-cart-features-empty-cart-view.png)
